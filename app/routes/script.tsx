    ...
    async function fetchFocusPoints() {
        try {
            const response = await axios.post(
                ...
                {
                    model: "gpt-3.5-turbo",
                    messages: [{role:"system", content: `You are going to provide a list of focus points for someone who is looking at a car at a dealership. The user has gone through and answered a bunch of questions that I will provide you the data for right now:
